...
import styles from "../../styles/dashboard/TableFilter.module.scss";
...
export default function TableFilter({ onFilter, onReset, onClose }: TableFilterProps) {
  ...
  return (
    <form className={styles.filterDropdown} onSubmit={handleSubmit} onClick={(e) => e.stopPropagation()}>
      ...
      <div className={styles.buttonGroup}>
        <Button type="button" variant="primaryOutline" size="sm" fullWidth onClick={handleResetClick}>
          Reset
        </Button>
